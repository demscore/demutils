...
prep_w_cy <- function(df, ...) {
  ...
  df %<>% mutate(vdem_vparty_country_name = case_when(
    ...
    vdem_vparty_country_name == 'Turkey' ~ 'Türkiye',
...
create_psdi <- function(df, ...){
  ...
  psdi_data$v2xpas_democracy_government <- 1-(psdi_data$v2xpas_democracy_government)
  psdi_data$v2xpas_democracy_opposition_adj <- 1-(psdi_data$v2xpas_democracy_opposition_adj)
...
create_psdi_codelow <- function(df, ...){
  ...
  psdi_data_low$v2xpas_democracy_government_codelow <- 1-(psdi_data_low$v2xpas_democracy_government_codelow)
  psdi_data_low$v2xpas_democracy_opposition_codelow_adj <- 1-(psdi_data_low$v2xpas_democracy_opposition_codelow_adj)
...
create_psdi_codehigh <- function(df, ...){
  ...
  psdi_data_high$v2xpas_democracy_government_codehigh <- 1-(psdi_data_high$v2xpas_democracy_government_codehigh)
  psdi_data_high$v2xpas_democracy_opposition_codehigh_adj <- 1-(psdi_data_high$v2xpas_democracy_opposition_codehigh_adj)
...
create_psrei <- function(df, ...) {
  ...
  relps_data$v2xpas_religion_government <- scales::rescale(relps_data$v2xpas_religion_government, to = c(0, 1))
  relps_data$v2xpas_religion_opposition_adj <- scales::rescale(relps_data$v2xpas_religion_opposition_adj, to = c(0, 1))
  
  relps_data$v2xpas_religion_government <- 1-relps_data$v2xpas_religion_government
  relps_data$v2xpas_religion_opposition_adj <- 1-relps_data$v2xpas_religion_opposition_adj
...
create_psrei_codelow <- function(df, ...){
  ...
  relps_data_low$v2xpas_religion_government_codelow <- scales::rescale(relps_data_low$v2xpas_religion_government_codelow, to = c(0, 1))
  relps_data_low$v2xpas_religion_opposition_codelow_adj <- scales::rescale(relps_data_low$v2xpas_religion_opposition_codelow_adj, to = c(0, 1))
  
  relps_data_low$v2xpas_religion_government_codelow <- 1-relps_data_low$v2xpas_religion_government_codelow
  relps_data_low$v2xpas_religion_opposition_codelow_adj <- 1-relps_data_low$v2xpas_religion_opposition_codelow_adj
...
create_psrei_codehigh <- function(df, ...){
  ...
  relps_data_high$v2xpas_religion_government_codehigh <- scales::rescale(relps_data_high$v2xpas_religion_government_codehigh, to = c(0, 1))
  relps_data_high$v2xpas_religion_opposition_codehigh_adj <- scales::rescale(relps_data_high$v2xpas_religion_opposition_codehigh_adj, to = c(0, 1))
  
  relps_data_high$v2xpas_religion_government_codehigh <- 1-relps_data_high$v2xpas_religion_government_codehigh
  relps_data_high$v2xpas_religion_opposition_codehigh_adj <- 1-relps_data_high$v2xpas_religion_opposition_codehigh_adj
...
create_psexi <- function(df, ...){
  ...
  etps_data$v2xpas_exclusion_government <- scales::rescale(etps_data$v2xpas_exclusion_government, to = c(0, 1))
  etps_data$v2xpas_exclusion_opposition_adj <- scales::rescale(etps_data$v2xpas_exclusion_opposition_adj, to = c(0, 1))
  
  etps_data$v2xpas_exclusion_government <- 1-etps_data$v2xpas_exclusion_government
  etps_data$v2xpas_exclusion_opposition_adj <- 1-etps_data$v2xpas_exclusion_opposition_adj
...
create_psexi_codelow <- function(df, ...) {
  ...
  etps_data_low$v2xpas_exclusion_government_codelow <- 
    scales::rescale(etps_data_low$v2xpas_exclusion_government_codelow, to = c(0, 1))
  etps_data_low$v2xpas_exclusion_opposition_codelow_adj <- 
    scales::rescale(etps_data_low$v2xpas_exclusion_opposition_codelow_adj, to = c(0, 1))
  
  etps_data_low$v2xpas_exclusion_government_codelow <- 
    1-etps_data_low$v2xpas_exclusion_government_codelow
  etps_data_low$v2xpas_exclusion_opposition_codelow_adj <- 
    1-etps_data_low$v2xpas_exclusion_opposition_codelow_adj
...
create_psexi_codehigh <- function(df, ...) {
  ...
  etps_data_high$v2xpas_exclusion_government_codehigh <- 
    scales::rescale(etps_data_high$v2xpas_exclusion_government_codehigh, to = c(0, 1))
  etps_data_high$v2xpas_exclusion_opposition_codehigh_adj <- 
    scales::rescale(etps_data_high$v2xpas_exclusion_opposition_codehigh_adj, to = c(0, 1))
  
  etps_data_high$v2xpas_exclusion_government_codehigh <- 
    -etps_data_high$v2xpas_exclusion_government_codehigh
  etps_data_high$v2xpas_exclusion_opposition_codehigh_adj <- 
    1-etps_data_high$v2xpas_exclusion_opposition_codehigh_adj
