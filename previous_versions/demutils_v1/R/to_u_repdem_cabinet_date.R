...
# Adjust vdem country names to repdem names
df %<>% 
  dplyr::mutate(u_vdem_country_date_country_name = case_when(
    u_vdem_country_date_country_name == "Netherlands" ~ "the Netherlands",
    u_vdem_country_date_country_name == "Czechia" ~ "Czech Republic",
